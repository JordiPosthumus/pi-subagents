/** Owner policy for the local-AI fork. This is deliberately not a tool argument. */
...
export const LOCAL_INFERENCE_POLICY_NOTICE = "Local-AI fork: execution and inference deadlines disabled by owner policy; manual cancellation remains enabled.";
