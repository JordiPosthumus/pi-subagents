	...
	try {
		...
		try {
			...
			if (raw && typeof raw === "object" && !Array.isArray(raw)
				&& (Object.hasOwn(raw, "localInference") || Object.hasOwn(raw, "worktreeProvider") || Object.hasOwn(raw, "worktreeBranchPrefix") || Object.hasOwn(raw, "modelResponseAliases"))) throw error;
		} catch (readError) {
